...
pub fn all_least_squares_test_cases() -> Vec<LeastSquaresTestCase> {
    vec![
        ...
        LeastSquaresTestCase {
            ...
            expected_fnorm2: 0.5000000000E+01,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            name: "Linear Rank 1",
            expected_fnorm2: 0.2142857143E+01,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
            ...
            name: "Linear Rank 1",
            expected_fnorm2: 0.2420995001E+01,
            expected_info: 1,
        },
        ...
        LeastSquaresTestCase {
            ...
            name: "Linear Rank 1 Zero Columns",
            expected_fnorm2: 0.2000000000E+01,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            name: "Rosenbrock",
            expected_fnorm2: 0.0000000000E+00,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            name: "Freudenstein-Roth",
            expected_fnorm2: 0.4898979486E+02,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            name: "Bard",
            expected_fnorm2: 0.8214877306E-02,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            expected_fnorm2: 0.3075056038E-03,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            name: "Meyer",
            expected_fnorm2: 0.8794585517E+02,
            expected_info: 1,
        },
        // Watson (Problem 11)
        LeastSquaresTestCase {
            ...
            name: "Watson",
            expected_fnorm2: 0.2287676763E-02,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
            ...
            name: "Watson",
            expected_fnorm2: 0.1175695682E-05,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
            ...
            name: "Watson",
            expected_fnorm2: 0.2170000409E-07,
            expected_info: 1,
        },
        // Box3D (Problem 12)
        LeastSquaresTestCase {
        ...
        LeastSquaresTestCase {
            ...
            expected_fnorm2: 0.1243621823E+02,
            expected_info: 1,
        },
        ...
        LeastSquaresTestCase {
            ...
            name: "Brown-Dennis",
            expected_fnorm2: 0.8582220163E+05,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            name: "Chebyquad",
            expected_fnorm2: 0.1883300373E+01,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            name: "Chebyquad",
            expected_fnorm2: 0.6506280001E-02,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            name: "Brown Almost-Linear",
            expected_fnorm2: 0.1000000000E+01,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            name: "Osborne 1",
            expected_fnorm2: 0.5464894697E-04,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
        ...
        LeastSquaresTestCase {
            ...
            name: "Osborne 2",
            expected_fnorm2: 0.4013774100E-01,
            expected_info: 1,
        },
        LeastSquaresTestCase {
            id: TestCaseId {
